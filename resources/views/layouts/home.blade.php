                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 mb-md-0 mb-4 text-right">
                        ...
                        <ul class="ftco-footer-social p-0">
                            <li class="ftco-animate"><a href="{{ getYoutube() }}" data-toggle="tooltip"
                                    data-placement="top" title="Youtube"><span class="ion-logo-youtube"></span></a></li>
                            <li class="ftco-animate"><a href="{{ getTwitter() }}" data-toggle="tooltip"
                                    data-placement="top" title="Twitter"><span class="ion-logo-twitter"></span></a></li>
                            <li class="ftco-animate"><a href="{{ getFacebook() }}" data-toggle="tooltip"
                                    data-placement="top" title="Facebook"><span class="ion-logo-facebook"></span></a>
                            </li>
                            <li class="ftco-animate"><a href="{{ getInstagram() }}" data-toggle="tooltip"
